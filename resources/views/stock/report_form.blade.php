        ...
        <div class="form-row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <button class="btn btn-info btn-rounded" id="report-btn"> گزارش گرفتن&nbsp;<i
            ...
            <div class="col-md-2 ">
                <button class="btn btn-primary btn-rounded form-control" onclick="imprimir()"> چاپ کردن <i
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        // Pagination
        $(".showDetailQuantity").click(function (event) {
        ...
        $('#report-btn').click(function () {
            ...
            $.ajax({
                ...
                method: 'post',
                data: {_token: _token, stack_id: stack_id, page: 3},
                dataType: 'json',
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            if (data[i].quantity > data[i].min_value) {
                                table += '<tr>' +
                                    ...
                                    '<td >' + data[i].quantities + '</td>' +
                                    '<td>' + data[i].unit_name + '</td>' +
                                    "<td> <button productId='" + data[i].product_id + "'class='btn btn-violet btn-xs showDetailQuantity' >تعداد | قمیت</button></td>" +
                                    '</tr>';
                            } else {
