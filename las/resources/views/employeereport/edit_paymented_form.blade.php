<div class="col-lg-8 col-md-8 col-xs-12">
    ...
    <form method="post" id="frm" action="{{ route('employeereport.paymented_update',$salary->payment_id) }}">
        ...
        <a href="javascript:ajaxLoad('{{ route('employeereport.paymented') }}')" class="btn btn-danger">لغو<i class="fa fa-backward" style="margin-right: 5px;"></i></a>
    </form>
