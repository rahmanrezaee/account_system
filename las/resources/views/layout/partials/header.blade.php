...
<head>
    ...
    <title>Tutia Services Company </title>

    <!-- Main Styles -->
    <link rel="stylesheet" href="{{asset('assets/styles/style.min.css')}}">

    <link rel="stylesheet" href="{{asset('assets/fonts/font-main.css')}}">
    ...
    {{--Gritter--}}
    <link rel="stylesheet" href="{{asset('assets/plugin/gritter/jquery.gritter.css')}}">
    ...
    {{--autocomplete css--}}
    <link rel="stylesheet" href="{{asset('assets/plugin/autocomplete/jquery-ui.min.css')}}">
    <!-- Data Tables -->
    ...
    <link rel="stylesheet" href="{{asset('assets/plugin/datatables/buttons.dataTables.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/plugin/persianDatepicker/css/persianDatepicker-default.css')}}">


</head>

<body style="font-family: 'SahelFont' !important ">