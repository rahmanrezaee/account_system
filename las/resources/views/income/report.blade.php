            ...
            <div class="col col-md-3">
                <div class="form-group " id="between_date">
                    <label for="end_date" class="control-label ">تاریخ:*</label>
                        <input type="text"  value="" class="form-control  date-picker end_date" placeholder="روز/ماه/سال"
                               name="end_date">
                ...
                success: function (data) {
                    ...
                    if (data[0].finaldata){
                        var h = "<tr>" +
                            ...
                            "<td>" +new Intl.NumberFormat({ style: 'currency', currency: 'AFN' }).format(data[0].finaldata.total_car_income)+"</td>"+
