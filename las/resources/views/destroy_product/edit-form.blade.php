...
<div class="row">
    <div class="col-md-12">
        <form action="{{route('destroy_product.edit',$id)}}" method="post" id="frm">
            {{csrf_field()}}
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <select  name="stack_name" id="stack_name" class="form-control select2_1 dynamic" data-state="company">
                        <option value="" selected="selected">{{$store->store_name}}</option>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="تاریخ/روز/سال" id="jalali-datepicker" name="pr_date" autocomplete="off" value="{{$store->date}}">
                ...
                <div class="col-md-12 table-responsive">
                    ...
                    <table class="table table-bordered table-striped " style="margin-bottom: 8px;" >
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="product_name[]" id="product_name_1" data-field-name="product_name"  class="form-control input-sm auto_txt" value="{{$dest->product_name}}">
                                <input type="hidden" name="product_id[]" id="product_id_1" class=" auto_txt" value="{{$dest->product_id}}">
                                <input type="hidden" name="dest_product_id[]" id="product_id_1" class=" auto_txt" value="{{$dest->dest_pro_id}}">
                                <input type="hidden" name="product_store_id[]" id="product_store_id_1" class="form-control input-sm  auto_txt" value="{{$dest->product_stor_id}}"><input type="hidden" name="product_unit_quantity[]" id="product_unit_quantity_1" class="form-control input-sm  auto_txt" value="{{$dest->unit_quantity}}"></td>
                            <td><input type="number" name="product_quantity[]" id="product_quantity_1" class="form-control input-sm  auto_txt quantity amount" value="{{$dest->quantity}}"></td>
                            <td><input type="number" name="package_price[]" id="package_price_1" class="form-control input-sm  auto_txt price amount" value="{{$dest->package_price}}"></td>
                            <td><input type="number" name="total_price[]" id="total_price_1" class="form-control input-sm  auto_txt total_amount" value="{{$dest->total_price}}"></td>
